...
ATriggerVolume* PressurePlate=nullptr; //it's a pointer !!! opens a menu in unreal that lets us pick any aAtriggervolume from the world and PressurePlate will be the pointer of that object
